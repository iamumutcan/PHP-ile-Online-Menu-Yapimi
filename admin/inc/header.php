...
{
?>
   <meta http-equiv="refresh" content="0;url=<?=SITE?>giris-yap.php">
  <?php
  exit();
}
 ?>
...
<head>
  ...
  <title>UCY MEDYA - ÖZEL ADMİN PANELİ SİSTEMLERİ</title>
  ...
  <div class="wrapper">
    ...
    <aside class="sidebar-wrapper" data-simplebar="true">
      <div class="sidebar-header"> 
        ...
        <div>
          <h4 class="logo-text">UCY MEDYA</h4>
        </div>
      ...
      <ul class="metismenu" id="menu">
        <li>
            <a href="index.php" >
              <div class="parent-icon"><ion-icon name="home-sharp" role="img" class="md hydrated" aria-label="home sharp"></ion-icon>
              </div>
          ...
          <li>
            <a href="<?=SITE?>index.php?sayfa=moduk-ekle" >
              <div class="parent-icon"><ion-icon name="copy-sharp" role="img" class="md hydrated" aria-label="copy sharp"></ion-icon>
              </div>
              <div class="menu-title">Kategori Ekle</div>
            </a>
          </li>
          <li>
            <a href="<?=SITE?>index.php?sayfa=moduller" >
              <div class="parent-icon"><ion-icon name="copy-sharp" role="img" class="md hydrated" aria-label="copy sharp"></ion-icon>
              </div>
              <div class="menu-title">Kategori Düzenle</div>
            </a>
          </li>
          <li>
            <a href="<?=SITE?>siteayarlari.php" >
              <div class="parent-icon"><ion-icon name="document-text-sharp" role="img" class="md hydrated" aria-label="document text sharp"></ion-icon>
              </div>
                      ...
                      if($moduller!=false)
                        {
                            ...
                            {
                                ?>
                    <li> <a href="<?=SITE?>index.php?sayfa=liste&tablo=<?=$moduller[$i]["tablo"]?>" >
                <ion-icon name="ellipse-outline"></ion-icon><?=$moduller[$i]["baslik"]?>
                        </a>
                   </li>
          ...
          <ul class="navbar-nav align-items-center">
            ...
            <li class="nav-item dropdown dropdown-user-setting">
              ...
              <ul class="dropdown-menu dropdown-menu-end">
                ...
                <li>
                  <a class="dropdown-item" href="<?=SITE?>index.php?sayfa=cikis">
                    <div class="d-flex align-items-center">
                      <div class="">
